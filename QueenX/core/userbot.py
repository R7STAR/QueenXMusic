    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                ...
                await self.one.join_chat("itz_Lucky_Raja")
                await self.one.join_chat("Time_Pass_Back")
                await self.one.join_chat("Play_Quiz_Study")
            except:
                pass
            assistants.append(1)
        ...
        if config.STRING2:
            ...
            try:
                ...
                await self.two.join_chat("itz_Lucky_Raja")
                await self.two.join_chat("Time_Pass_Back")
                await self.two.join_chat("Play_Quiz_Study")
            except:
                pass
            assistants.append(2)
        ...
        if config.STRING3:
            ...
            try:
                ...
                await self.three.join_chat("itz_Lucky_Raja")
                await self.three.join_chat("Time_Pass_Back")
                await self.three.join_chat("Play_Quiz_Study")
            except:
                pass
            assistants.append(3)
        ...
        if config.STRING4:
            ...
            try:
                ...
                await self.four.join_chat("itz_Lucky_Raja")
                await self.four.join_chat("Time_Pass_Back")
                await self.four.join_chat("Play_Quiz_Study")
            except:
                pass
            assistants.append(4)
        ...
        if config.STRING5:
            ...
            try:
                ...
                await self.five.join_chat("Play_Quiz_Study")
                await self.five.join_chat("Time_Pass_Back")
            except:
                pass
            assistants.append(5)
