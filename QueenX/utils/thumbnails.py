...
async def gen_thumb(videoid, chat_id):
    ...
    try:
        ...
        bg = Image.open(f"QueenX/assets/bg.png")
        ...
        font = ImageFont.truetype("QueenX/assets/font2.ttf", 45)
        ImageFont.truetype("QueenX/assets/font2.ttf", 70)
        arial = ImageFont.truetype("QueenX/assets/font2.ttf", 30)
        ImageFont.truetype("QueenX/assets/font.ttf", 30)
